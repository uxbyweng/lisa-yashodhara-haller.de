...
<div class="fancy-feature-two position-relative pt-200 lg-pt-120">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-8 col-sm-10 offset-md-1 ms-auto d-none d-lg-block">
                <div class="img-meta-two d-inline-block d-flex justify-content-end pb-50">
                    <img src="/images/courses/photo_2024-01-03_16-18-49.jpg" height="60%" width="60%">
                </div>
            </div>
            <div class="col-xl-5 col-lg-7 d-lg-none d-block">
                <div class="img-meta-two d-inline-block position-relative pb-50">
                    <img src="/images/courses/photo_2024-01-03_16-18-40.jpg">
                </div>
            </div>
        </div>
    </div>
...
<div class="portfolio-gallery-four">
    <div class="container">
        ...
        <section>
            <!-- 01 -->
            <div class="isotop-item hcard guestlectures">
                <div class="row">
                    <div class="col-sm-1 p-5 col-lg-1 d-none d-sm-block">
                        <i class="fa-solid fa-microphone-lines fa-2xl"></i>
                    </div>
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h3>
                            Ökonomie – Care- Ethik
                        </h3>
                        <span>
                            Vortrag im Rahmen der Ringvorlesung “Paradigmen und Kontroversen ökonomischer Theorien” Freie Universität Berlin, WS 2024/25
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="isotop-item hcard guestlectures">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        ...
                        <span>
                            Vortrag im Rahmen der Ringvorlesung „Plurale Ökonomie“ Universität Hamburg, WS 2024/25
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="isotop-item hcard guestlectures">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h3>
                            Staat, Ökonomie, Geschlecht
                        </h3>
                        <span>
                            Vortrag im Rahmen der Ringvorlesung ”Plurale Ökonomie“, Universität Hamburg, WS 2023/24
                        </span>
                    </div>
                </div>
            </div>
        <!-- 01 -->
            <div class="isotop-item hcard guestlectures">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4"> 
                        ...
                        <span>
                            Vortrag im Rahmen der Ringvorlesung ”Plurale Ökonomie“ Universität Hamburg, 12/2023
                        </span>
                    </div>
                </div> 
            </div> 
            ...
            <div class="isotop-item hcard guestlectures">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4"> 
                        <h3>
                            Care und die Grenzen des Wachstums – Analysen der feministischen Wachstumskritik
                        </h3>
                        <span>
                            Vortrag im Rahmen der Ringvorlesung „Ist Wachstum zukunftsfähig - Wieviel ist genug?“, Universität Hamburg, 01/2023
                        </span>
                    </div>
                </div> 
            </div> 
            ...
            <div class="isotop-item hcard guestlectures">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4"> 
                        ...
                        <span>
                            Vortrag im Rahmen der Ringvorlesung „Femnismen im globalen Kontext – Perspektiven – Bewegungen – Beziehungen“, Katholische Universität Eichstätt-Ingolstadt, 11/2022
                        </span>
                    </div>
                </div> 
            </div> 
            ...
            <div class="isotop-item hcard guestlectures">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4"> 
                        ...
                        <span>
                            Online Vortrag im Rahmen der Ringvorlesung „Geschlechterforschung“, Universität Osnabrück, 12/2020
                        </span>
                    </div>
                </div> 
            </div>
            ...
            <div class="isotop-item hcard guestlectures">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4"> 
                        ...
                        <span>
                            Vortrag im Rahmen der Ringvorlesung am Institut für Diversitätsforschung, Georg-August-Universität Göttingen, 01/2020
                        </span>
                    </div>
                </div> 
            </div>
        ...
        <section>
            <!-- 01 -->
            <div class="isotop-item hcard courses">
                <div class="row">
                    <div class="col-sm-1 p-5 d-none d-sm-block">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        ...
                        <a href="https://www.fu-berlin.de/vv/de/lv/677332?m=182264&pc=74959&sm=653109" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | fu-berlin.de
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Der Sozialstaat in einer feministischen Analyse
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://www.fu-berlin.de/vv/de/lv/577463?m=327894&amp;p=327889&amp;pc=336266&amp;sm=528624" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | fu-berlin.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Geschlecht in der Kinder- und Jugendhilfe
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://lsf.uni-hildesheim.de/qisserver/rds?state=verpublish&status=init&vmfile=no&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung&veranstaltung.veranstid=81029" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | uni-hildesheim.de
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Wenn sich Problemlagen verallgemeinern – Zukunft und Mandate der Sozialen Arbeit
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://lsf.uni-hildesheim.de/qisserver/rds?state=verpublish&status=init&vmfile=no&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung&veranstaltung.veranstid=77285" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | uni-hildesheim.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Wirkungsanalysen – Wohlfahrtsstaatliche Leistungen in der empirischen Analyse
                        ...
                        <a href="https://lsf.uni-hildesheim.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=77286&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | uni-hildesheim.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        ...
                        <a href="https://lsf.uni-hildesheim.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=77287&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | uni-hildesheim.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Masterbegleitende Forschungs- und Schreibkolloquium
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://lsf.uni-hildesheim.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=74509&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                        Zur Veranstaltung | uni-hildesheim.de
                        </a>
                    </div>
                </div>
            ...
            <!-- 8 -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        ...
                        <a href="https://www.dhbw-vs.de/hochschule/forschung-transfer/fakultaet-sozialwesen.html" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                        Zur Veranstaltung | dhbw-vs.de
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Sozialpolitik – Funktion, Prinzipien & Akteure
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://lsf.uni-hildesheim.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=75050&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                        Zur Veranstaltung | uni-hildesheim.de
                        </a>
                    </div>
                </div>
            ...
            <!-- 10 -->
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Organisationsformen und Strukturprinzipien personenbezogener Dienstleistungen
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://lsf.uni-hildesheim.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=75051&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                        Zur Veranstaltung | uni-hildesheim.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        ...
                        <a href="https://lsf.uni-hildesheim.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=74079&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                        Zur Veranstaltung | uni-hildesheim.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Freiheit und Angewiesenheit. Zu den Herausforderungen einer feministischen Debatte
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://www.fu-berlin.de/vv/de/lv/465062?m=51295&pc=26558&sm=411506" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | fu-berlin.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        ...
                        <a href="https://portal.uni-kassel.de/qisserver/rds?state=verpublish&status=init&vmfile=no&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung&veranstaltung.veranstid=134573" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | portal.uni-kassel.de
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Geschlechtertheoretische Perspektiven auf Arbeit
                        </h2>
                        <p class="font--777 fs-18">
                            2 SWS im MA, Institut für Sozialwesen, Universität Kassel, WS 2017/18
                        </p>
                        ...
                        <a href="https://portal.uni-kassel.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=135433&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | portal.uni-kassel.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Geschlechteraspekte in den Teilgebieten der Politikwissenschaft
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://www.uni-giessen.de/de/fbz/fb03/institutefb03/ifp/studienprofil/ueberblick" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | uni-giessen.de
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Das Paar in der empirischen Sozialforschung
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://portal.uni-kassel.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=118216&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | portal.uni-kassel.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Geschlechterverhältnisse in der Politikwissenschaft
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://www.uni-marburg.de/de/fb03/politikwissenschaft" target="_blank" rel="nofollow" class="btn-hcard tran3s">
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Soziale Ungleichheit und Prekarisierung vor dem Hintergrund aktueller sozialstaatlicher Wandlungsprozesse
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://portal.uni-kassel.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=45929&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | portal.uni-kassel.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Der institutionelle Wandel des deutschen Wohlfahrtsstaates
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://portal.uni-kassel.de/qisserver/rds?state=verpublish&status=init&vmfile=no&publishid=42889&moduleCall=webInfo&publishConfFile=webInfo&publishSubDir=veranstaltung" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | portal.uni-kassel.de
                        </a>
                    </div>
                </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Wandel von Arbeit, Ökonomie und Gleichstellungspolitiken im Postfordismus? Theoretische Perspektiven und vergleichende Analysen am Beispiel USA – Deutschland
                        </h2>
                        <p class="font--777 fs-18">
                        ...
                        <a href="https://www.jfki.fu-berlin.de/" target="_blank" rel="nofollow" class="btn-hcard tran3s">
                            Zur Veranstaltung | jfki.fu-berlin.de
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="isotop-item hcard courses">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-9 col-lg-10 px-5 py-4 p-sm-4">
                        <h2>
                            Politische Ökonomie der sozialen Ungleichheit und der Geschlechterdifferenz
                        </h2>
                        <p class="font--777 fs-18">
