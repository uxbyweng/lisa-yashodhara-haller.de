...
function youtube_video($youtube_id, $start_time = 0) {
    ...
    echo '<div class="yt-facade video-banner" data-yt-id="' . $id . '" data-yt-start="' . $start . '" role="button" tabindex="0" aria-label="Video abspielen" style="background: url(/images/yt-thumbs/' . $id . '.jpg) no-repeat center; background-size: cover;">';
